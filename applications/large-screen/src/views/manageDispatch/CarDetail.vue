  ...
  <div class="car-detail">
    ...
    <div class="table-area">
      ...
      >
        ...
        >
          <template #default="scope">
            <el-button @click="showTrajectory(scope.row)" size="small" type="text"
              >查看轨迹</el-button
            >
          </template>
        </el-table-column>
    ...
    >
      <!-- <trajectory
        ...
        markerUrl="/ruralLivingEnv/img/facilities/marker-car.png"
        requestUrl="/graphShow/queryCarTrack"
      ></trajectory> -->
    </el-dialog>
  </div>
</template>
...
import { carRecord } from '@/api/manageDispatch/event'
...
.car-detail .info-area {
  position: relative;
  padding-bottom: 15px;
}

.car-detail .info-area > .info-item {
  font-size: 14px;
  line-height: 24px;
}

.car-detail .info-area > .info-item > span {
  color: #a6ffeb;
}
...
.car-detail .table-area {
  padding-top: 15px;
  border-top: 1px solid rgba(0, 232, 156, 0.3);
}

.car-detail .table-area .table-title {
  margin-bottom: 15px;

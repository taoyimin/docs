import{b as B,d as p,q as F,r as x,v as T,s as w,t as I,u as _,f as S,h as P,w as R}from"./chunks/theme.C9jPID2_.js";import"./chunks/base.l0sNRNKZ.js";/* empty css                               *//* empty css                      *//* empty css                         *//* empty css                     *//* empty css                              *//* empty css                      *//* empty css                   *//* empty css                        *//* empty css                     *//* empty css                         *//* empty css                      *//* empty css                            *//* empty css                            *//* empty css                      */import"./chunks/select.DP2rzg_V.js";/* empty css                     *//* empty css                        *//* empty css                           */import"./chunks/grid-cascader.l0sNRNKZ.js";/* empty css                         *//* empty css                       *//* empty css                     *//* empty css                      *//* empty css                         *//* empty css                    *//* empty css                     *//* empty css                       */import{d as o,p as d,o as g,b as c,c as b,G as k,_ as v,v as M,w as l,j as i,a as s,B as f,b2 as D}from"./chunks/framework.Cv9N_OZb.js";/* empty css                      *//* empty css                     *//* empty css                         *//* empty css                         */const N=o({__name:"data-form.md.demo.9c3bede2",setup(y){const E=d({input:"",textarea:"",phone:"",idcard:"",ciphertext:"张*",cipherPhone:"173****8888",cipherIdcard:"4209**********6415",select:"",cascader:"",radio:"",checkbox:"",date:"",startDate:"",endDate:"",time:"",startTime:"",endTime:"",datetime:"",startDatetime:"",endDatetime:"",switch:!0,number:0,min:0,max:0,rate:0,color:"",image:"",audio:"",video:"",file:"",dict:"",grid:"",longitude:null,latitude:null,address:"",verify:"",richText:""}),a=[{prop:"input",label:"输入框",fieldType:"input",prefix:"头部",suffix:"尾部",prepend:"前置",append:"后置"},{prop:"textarea",label:"文本域",fieldType:"textarea"},{prop:"phone",label:"手机号",fieldType:"phone"},{prop:"idcard",label:"身份证",fieldType:"idcard"},{prop:"ciphertext",label:"加密文本",fieldType:"ciphertext",decrypt:(n,h)=>B.post("/api/decrypt/name",{...n,...h}).then(t=>t.data)},{prop:"cipherPhone",label:"加密手机号",fieldType:"cipherPhone",decrypt:(n,h)=>B.post("/api/decrypt/phone",{...n,...h}).then(t=>t.data)},{prop:"cipherIdcard",label:"加密身份证",fieldType:"cipherIdcard",decrypt:(n,h)=>B.post("/api/decrypt/idcard",{...n,...h}).then(t=>t.data)},{prop:"select",label:"选择器",fieldType:"select",data:[{label:"选项1",value:"1"},{label:"选项2",value:"2"},{label:"选项3",value:"3"}]},{prop:"cascader",label:"级联选择器",fieldType:"cascader",data:[{label:"选项1",value:"1",children:[{label:"子选项1-1",value:"1-1"},{label:"子选项1-2",value:"1-2"}]},{label:"选项2",value:"2",children:[{label:"子选项2-1",value:"2-1"},{label:"子选项2-2",value:"2-2"},{label:"子选项2-3",value:"2-3"}]},{label:"选项3",value:"3",children:[{label:"子选项3-1",value:"3-1"},{label:"子选项3-2",value:"3-2"}]}]},{prop:"radio",label:"单选框",fieldType:"radio",data:[{label:"选项1",value:"1"},{label:"选项2",value:"2"},{label:"选项3",value:"3"}]},{prop:"checkbox",label:"多选框",fieldType:"checkbox",data:[{label:"选项1",value:"1"},{label:"选项2",value:"2"},{label:"选项3",value:"3"}]},{prop:"date",label:"日期选择器",fieldType:"date"},{prop:["startDate","endDate"],label:"日期范围选择器",fieldType:"dateRange",valueFormat:"YYYY-MM-DD HH:mm:ss"},{prop:"time",label:"时间选择器",fieldType:"time"},{prop:["startTime","endTime"],label:"时间范围选择器",fieldType:"timeRange"},{prop:"datetime",label:"日期时间选择器",fieldType:"datetime"},{prop:["startDatetime","endDatetime"],label:"日期时间范围选择器",fieldType:"datetimeRange"},{prop:"switch",label:"开关",fieldType:"switch"},{prop:"number",label:"数字输入框",fieldType:"number"},{prop:["min","max"],label:"数字范围",fieldType:"numberRange"},{prop:"rate",label:"评分",fieldType:"rate"},{prop:"color",label:"颜色",fieldType:"color"},{prop:"image",label:"图片上传",fieldType:"image",limit:1,maxSize:1024*2,extensions:["jpg","png"]},{prop:"audio",label:"音频上传",fieldType:"audio"},{prop:"video",label:"视频上传",fieldType:"video"},{prop:"file",label:"文件上传",fieldType:"file"},{prop:"dict",label:"字典选择器",fieldType:"dict",dictType:"status"},{prop:"grid",label:"网格选择器",fieldType:"grid"},{prop:["longitude","latitude","address"],label:"地图选点",fieldType:"location"},{prop:"verify",label:"验证码",fieldType:"verify"},{prop:"richText",label:"富文本",fieldType:"richText"}];function e(n){p.success(`提交的表单内容：${JSON.stringify(n)}`)}return(n,h)=>{const t=F;return g(),c(t,{model:E.value,fields:a,onSubmit:e},null,8,["model"])}}}),V=o({__name:"data-form.md.demo.9c3bede0",setup(y){const E=d({no:"",status:""}),a=[{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]}];function e(m){return new Promise((u,A)=>{setTimeout(()=>{u("提交成功")},2e3)})}function n(m){p.success("点击了查询按钮")}function h(m,u){p.success("点击了重置按钮"),u==null||u.resetFields()}function t(m){p.success("点击了新增按钮")}function r(m){p.success("点击了批量删除按钮")}function C(m){p.success("点击了返回按钮")}return(m,u)=>{const A=F;return g(),b("div",null,[k(A,{model:E.value,fields:a,onSubmit:e,onSearch:n,onReset:h,onBack:C,onAdd:t,onBatchDelete:r},null,8,["model"])])}}}),$=v(V,[["__scopeId","data-v-a24f94d9"]]),U=o({__name:"data-form.md.demo.9c3bedde",setup(y){const E=d({no:"",status:""}),a=[{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]}],e=[{name:"暂存",type:"warning",onClick:h=>new Promise((t,r)=>{setTimeout(()=>{t("暂存成功")},2e3)})},{name:"清空",type:"danger",onClick:h=>{p.error("点击了清空按钮")}}];function n(h){p.success("点击了提交按钮")}return(h,t)=>{const r=F;return g(),c(r,{model:E.value,fields:a,buttons:e,onSubmit:n},null,8,["model"])}}}),q=o({__name:"data-form.md.demo.9c3beddc",setup(y){const E=d({no:"",status:""}),a=[{prop:"no",label:"事件编号",fieldType:"input",authority:"superAdmin"},{prop:"status",label:"事件状态",fieldType:"select",authority:["superAdmin","docAdmin"],data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]}],e=[{name:"暂存",type:"warning",authority:"superAdmin",onClick:t=>{p.warning("点击了带superAdmin权限的暂存按钮")}},{name:"清空",type:"danger",authority:["superAdmin","docAdmin"],onClick:t=>{p.error("点击了带superAdmin或docAdmin权限的清空按钮")}}];function n(t){p.success("点击了带superAdmin权限的提交按钮")}function h(t){p.success("点击了带superAdmin或docAdmin权限的返回按钮")}return(t,r)=>{const C=F;return g(),c(C,{model:E.value,fields:a,buttons:e,"onSubmit(superAdmin)":n,"onBack(superAdmin|docAdmin)":h},null,8,["model"])}}}),O=o({__name:"data-form.md.demo.9c3bedda",setup(y){const E=d({id:"123",name:"张*",phone:"173****8888"}),a=[{prop:"id"},{prop:"name",label:"姓名",fieldType:"ciphertext",type:"blockPuzzle",decrypt:(h,t)=>B.post("/api/decrypt/name",{id:t.id,...h}).then(r=>r.data)},{prop:"phone",label:"手机号",fieldType:"ciphertext",type:"clickWord",decrypt:(h,t)=>B.post("/api/decrypt/phone",{id:t.id,...h}).then(r=>r.data)}];function e(h){p.success(`提交的表单内容：${JSON.stringify(h)}`)}function n(h,t){p.success("点击了重置按钮"),t==null||t.resetFields()}return(h,t)=>{const r=F;return g(),c(r,{model:E.value,fields:a,onSubmit:e,onReset:n},null,8,["model"])}}}),L=o({__name:"data-form.md.demo.9c3bedd8",setup(y){const E=d({no:""}),a=[{prop:"no",label:"事件编号",fieldType:"input"}];function e(t){p.success(`搜索的表单内容：${JSON.stringify(t)}`)}function n(t){p.success("点击了新增按钮")}function h(t){p.success("点击了批量删除按钮")}return(t,r)=>{const C=F;return g(),c(C,{model:E.value,fields:a,inline:"",onSearch:e,onAdd:n,onBatchDelete:h},null,8,["model"])}}}),z=o({__name:"data-form.md.demo.9c3bedd6",setup(y){const E=d({name:"",age:"",gender:"",address:"",phone:"",remark:""}),a=[[{prop:"name",label:"姓名",fieldType:"input"},{prop:"age",label:"年龄",fieldType:"input"},{prop:"gender",label:"性别",fieldType:"input"}],[{prop:"address",label:"家庭地址",fieldType:"input",span:16},{prop:"phone",label:"电话",fieldType:"input",span:8}],{prop:"remark",label:"详细描述",fieldType:"textarea"}];return(e,n)=>{const h=F;return g(),c(h,{model:E.value,fields:a},null,8,["model"])}}}),J=o({__name:"data-form.md.demo.9c3bedd4",setup(y){const E=d({id:"",no:"",status:"",addTime:"",imageUrl:""}),a=[{prop:"id",label:"事件ID"},{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]},{prop:"addTime",label:"上报时间",fieldType:"date"},{prop:"imageUrl",label:"事件图片",fieldType:"image"}];M(()=>{B.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(n=>{E.value=x(n.data,Object.keys(E.value))})});function e(n){p.success(`提交的表单内容：${JSON.stringify(n)}`)}return(n,h)=>{const t=F;return g(),c(t,{model:E.value,fields:a,onSubmit:e},null,8,["model"])}}}),Y=o({__name:"data-form.md.demo.9c3bedd2",setup(y){const E=d({no:"",formType:"status",status:"",type:""}),a=d([{prop:"no",label:"编号",fieldType:"input",placeholder:"试试输入disabled"},{prop:"formType",label:"表单类型",fieldType:"radio",data:[{label:"事件状态",value:"status"},{label:"事件类型",value:"type"}],watchEffect(h){this.disabled=h.no==="disabled"}},{prop:"status",label:"事件状态",fieldType:"radio",labelKey:"dictName",valueKey:"dictCode",data:B.get("/api/dict/list?dictType=status").then(h=>h.data),watchEffect(h){this.show=h.formType==="status",this.disabled=h.no==="disabled"}},{prop:"type",label:"事件类型",fieldType:"checkbox",labelKey:"dictName",valueKey:"dictCode",data:B.get("/api/dict/list?dictType=type").then(h=>h.data),watchEffect(h){this.show=h.formType==="type",this.disabled=h.no==="disabled"}}]),e=d([{name:"重置",type:"warning",onClick:h=>{p.success("点击了重置按钮")},watchEffect(h){this.show=h.formType==="type",this.disabled=h.no==="disabled"}},{name:"返回",onClick:h=>{p.success("点击了返回按钮")},watchEffect(h){this.show=h.formType==="status",this.disabled=h.no==="disabled"}}]);function n(h){p.success(`提交的表单内容：${JSON.stringify(h)}`)}return(h,t)=>{const r=F;return g(),c(r,{model:E.value,fields:a.value,buttons:e.value,onSubmit:n},null,8,["model","fields","buttons"])}}}),K=o({__name:"data-form.md.demo.eb41cdfe",setup(y){const E=d({no:"",status:"",time:""}),a=[{prop:"no",label:"事件编号",required:!0,fieldType:"input"},{prop:"status",label:"事件状态",required:!0,fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]},{prop:"time",label:"上报时间",required:!0,fieldType:"date"}],e=[{name:"自定义校验按钮",type:"success",validate:!0,onClick:h=>{p.success("校验通过！")}},{name:"只校验事件状态",type:"success",onClick:(h,t)=>{t==null||t.validateField("status",r=>{r&&p.success("校验通过！")})}},{name:"清空校验结果",type:"warning",onClick:(h,t)=>{t==null||t.clearValidate()}}];function n(h){p.success("校验通过！")}return(h,t)=>{const r=F;return g(),b("div",null,[k(r,{model:E.value,fields:a,buttons:e,onSubmit:n},null,8,["model"])])}}}),j=v(K,[["__scopeId","data-v-afc6f909"]]),H=o({__name:"data-form.md.demo.eb41cdfc",setup(y){const E=d({name:"",age:"",phone:"",idcard:""}),a=[{prop:"name",label:"姓名",required:!0,fieldType:"input",rules:{validator:(n,h,t)=>{h?h.length<2?t(new Error("姓名必须大于等于2个字符")):h.length>4?t(new Error("姓名必须小于等于4个字符")):t():t(new Error("请输入姓名"))},trigger:["blur","change"]}},{prop:"age",label:"年龄",required:!0,fieldType:"input",rules:{validator:T,trigger:"blur"}},{prop:"idcard",label:"身份证",fieldType:"input",rules:{validator:w,trigger:"blur"}},{prop:"phone",label:"手机号",fieldType:"input",required:!0,rules:[{validator:T,trigger:"change"},{validator:I,trigger:"blur"}]}];function e(n){p.success("校验通过！")}return(n,h)=>{const t=F;return g(),c(t,{model:E.value,fields:a,onSubmit:e},null,8,["model"])}}}),W={class:"mention-container"},G=o({__name:"data-form.md.demo.eb41cdfa",setup(y){const E=d({no:"",status:"",person:"@"}),a=[{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"dict",dictType:"status"},{prop:"person",label:"处理人",fieldType:"slot"}],e=d([{label:"张三",value:"张三"},{label:"李四",value:"李四"},{label:"王五",value:"王五"},{label:"赵六",value:"赵六"}]);function n(t){p.success(`提交的表单内容：${JSON.stringify(t)}`)}function h(t){p.success("点击了指派按钮")}return(t,r)=>{const C=_,m=S,u=F;return g(),c(u,{model:E.value,fields:a,onSubmit:n},{person:l(()=>[i("div",W,[k(C,{modelValue:E.value.person,"onUpdate:modelValue":r[0]||(r[0]=A=>E.value.person=A),options:e.value,style:{width:"320px"},placeholder:"请输入"},null,8,["modelValue","options"]),k(m,{type:"success",onClick:h},{default:l(()=>r[1]||(r[1]=[s("指派")])),_:1})])]),_:1},8,["model"])}}}),Z=v(G,[["__scopeId","data-v-5785b740"]]),Q=o({__name:"data-form.md.demo.eb41cdf8",setup(y){const E=d({no:"",status:[],min:10,max:30,location:"",imageUrl:"",article:"",input:""}),a=[{prop:"no",label:"事件编号",fieldType:"input",placeholder:"自定义提示",maxlength:5},{prop:"status",label:"事件状态",fieldType:"select",multiple:!0,data:[{label:"待处理",value:"0"},{label:"待评价",value:"1",disabled:!0},{label:"已办结",value:"2"}]},{prop:["min","max"],label:"数字范围",fieldType:"numberRange",min:10,max:30},{prop:"location",label:"开启定位",fieldType:"switch",inlinePrompt:!0,activeText:"完整展示多个内容",inactiveText:"多个内容"},{prop:"imageUrl",label:"事件图片",fieldType:"image",listType:"picture",limit:1,tip:"最多上传一张图片"},{prop:"article",label:"文章内容",fieldType:"richText",editor:{defaultConfig:{placeholder:"自定义提示语",MENU_CONF:{uploadImage:{maxFileSize:1*1024*1024,onError(n,h,t){p.error(`${n.name} 上传出错：${h.message}`)}}}}}}];function e(n){p.success(`提交的表单内容：${JSON.stringify(n)}`)}return(n,h)=>{const t=P,r=R,C=F;return g(),c(C,{model:E.value,fields:a,onSubmit:e},{default:l(()=>[k(r,{prop:"input",label:"插槽输入框"},{default:l(()=>[k(t,{modelValue:E.value.input,"onUpdate:modelValue":h[0]||(h[0]=m=>E.value.input=m),placeholder:"请输入"},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])}}}),X={tabindex:"0"},ii={tabindex:"0"},si={tabindex:"0"},ai={tabindex:"0"},$i=JSON.parse('{"title":"Data Form 数据表单","description":"","frontmatter":{},"headers":[],"relativePath":"component/data-form.md","filePath":"component/data-form.md","lastUpdated":1751010229000}'),li={name:"component/data-form.md"},Ui=Object.assign(li,{setup(y){return(E,a)=>{const e=f("demo"),n=f("el-button"),h=f("el-popover");return g(),b("div",null,[a[135]||(a[135]=D(`<h1 id="Data Form 数据表单" tabindex="-1">Data Form 数据表单 <a class="header-anchor" href="#Data Form 数据表单" aria-label="Permalink to &quot;Data Form 数据表单&quot;">​</a></h1><p>该组件用于快速生成数据表单，内部封装了表单渲染、表单验证、文件处理等逻辑，只需传入<a href="#属性">fields</a>和<a href="#属性">model</a>属性即可。</p><h2 id="全局配置" tabindex="-1">全局配置 <a class="header-anchor" href="#全局配置" aria-label="Permalink to &quot;全局配置&quot;">​</a></h2><p>在全局配置组件属性。</p><details class="details custom-block"><summary>DataForm组件属性配置</summary><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">app.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provide</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">DATA_FORM_KEY</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre></div></details><h2 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h2>`,14)),k(e,{customClass:"",sourceCode:`<template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  formRef?."),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"resetFields"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"();")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:l(()=>[k(O)]),_:1}),a[145]||(a[145]=D('<div class="tip custom-block"><p class="custom-block-title">提示</p><p>加密表单项功能内部基于<a href="./verify.html">Verify</a>组件实现，使用前需要在<a href="./verify.html#全局配置">全局配置</a>好验证码组件的相关属性。</p></div><h2 id="行内表单" tabindex="-1">行内表单 <a class="header-anchor" href="#行内表单" aria-label="Permalink to &quot;行内表单&quot;">​</a></h2><p>通过<code>inline</code>属性，你可以用该组件来生成搜索栏，因为搜索栏本质上也是一个表单。</p>',3)),k(e,{customClass:"",sourceCode:`<template>
  <liv-data-form
    :model="form"
    :fields="fields"
    inline
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"];")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:l(()=>[k(z)]),_:1}),a[148]||(a[148]=D('<div class="warning custom-block"><p class="custom-block-title">注意</p><p>如果是<a href="#行内表单">行内表单</a>，则网格布局不会生效。</p></div><h2 id="设置默认值" tabindex="-1">设置默认值 <a class="header-anchor" href="#设置默认值" aria-label="Permalink to &quot;设置默认值&quot;">​</a></h2><p>在某些业务场景，例如修改详情功能，表单可能需要设置默认值，并且某些字段仅作为修改接口的参数，并不需要渲染在页面上。你可以通过<code>model</code>属性来实现表单数据的双向绑定，并且不设置<code>fieldType</code>字段实现把相关字段放在表单数据中，但是不进行渲染。</p>',3)),k(e,{customClass:"",sourceCode:`<template>
  <liv-data-form :model="form" :fields="fields" @submit="handleSubmit" />
</template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  ElMessage."),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"success"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"("),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},"`提交的表单内容：${"),i("span",{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"}},"JSON"),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},"."),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"stringify"),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},"("),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"form"),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},")"),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},"}`"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},");")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:l(()=>[k(Y)]),_:1}),a[151]||(a[151]=D('<h2 id="表单校验" tabindex="-1">表单校验 <a class="header-anchor" href="#表单校验" aria-label="Permalink to &quot;表单校验&quot;">​</a></h2><p>表单内部封装了校验逻辑，只有<code>required</code>属性为<code>true</code>的表单项才会自动生成校验规则。你可以通过给<code>buttons</code>属性中的按钮设置<code>validate</code>属性来开启表单校验，表单内置的提交和查询按钮<code>validate</code>属性默认为true。</p>',2)),k(e,{customClass:"",sourceCode:`<template>
  <div>
    <liv-data-form :model="form" :fields="fields" :buttons="buttons" @submit="handleSubmit" />
  </div>
</template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:l(()=>[k(Z)]),_:1}),a[156]||(a[156]=D('<h2 id="属性&amp;事件&amp;插槽透传" tabindex="-1">属性&amp;事件&amp;插槽透传 <a class="header-anchor" href="#属性&amp;事件&amp;插槽透传" aria-label="Permalink to &quot;属性&amp;事件&amp;插槽透传&quot;">​</a></h2><p>Data Form基于<a href="https://element-plus.org/zh-CN/component/form.html#form-attributes" target="_blank" rel="noreferrer">ElForm</a>封装，所以你可以传入<a href="https://element-plus.org/zh-CN/component/form.html#form-attributes" target="_blank" rel="noreferrer">ElForm</a>的所有属性和事件，并且在字段配置属性<code>fields</code>中，根据<code>fieldType</code>的不同，你可以透传属性和事件给对应的渲染组件，具体<code>fieldType</code>对应的渲染组件请查看<a href="#fieldtype可选值">fieldType可选值</a>。</p>',2)),k(e,{customClass:"",sourceCode:`<template>
  <liv-data-form :model="form" :fields="fields" @submit="handleSubmit">
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  VerifyFormItemField,</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   * </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@remarks</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> 组件内置的重置按钮已经实现了重置表单逻辑，设置\`showReset\`属性为\`true\`即可，也可以手动传入组件的</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@reset方法以覆盖表单的重置逻辑</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   * </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@defaultValue</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> false</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   */</span></span>

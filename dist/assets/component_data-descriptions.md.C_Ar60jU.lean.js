import{b as E,m as y,f as u,n as T,o as x,p as _}from"./chunks/theme.C9jPID2_.js";import"./chunks/base.l0sNRNKZ.js";/* empty css                   *//* empty css                      *//* empty css                      *//* empty css                            *//* empty css                       *//* empty css                      */import{d as F,p as r,v as c,o as e,b as d,w as h,c as f,C as w,F as S,G as t,a as i,t as P,_ as v,B as m,b2 as A,j as s}from"./chunks/framework.Cv9N_OZb.js";/* empty css                    *//* empty css                     *//* empty css                      *//* empty css                   */const I=F({__name:"data-descriptions.md.demo.2d2bcefc",setup(g){const p=r(),a=[{prop:"no",label:"事件编号"},{prop:"contactTelephone",label:"联系电话",fieldType:"ciphertext",decrypt:(l,n)=>E.post("/api/decrypt/phone",{id:n.id,...l}).then(k=>k.data)},{prop:"statusStr",label:"事件状态",fieldType:"tag"},{prop:"url",label:"链接地址",fieldType:"link"},{prop:"id",label:"事件二维码",fieldType:"qrcode"},{prop:"imageUrl",label:"事件图片",fieldType:"image"},{prop:"voiceUrl",label:"事件录音",fieldType:"audio",span:24},{prop:"htmlContent",label:"事件描述",fieldType:"richText"}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=y;return e(),d(k,{data:p.value,fields:a},null,8,["data"])}}}),N=F({__name:"data-descriptions.md.demo.2d2bcefa",setup(g){const p=r(),a=[{prop:"no",label:"事件编号"},{prop:"statusStr",label:"事件状态",fieldType:"tag"},{prop:"typeStr",label:"事件类型"},{prop:"contactTelephone",label:"联系电话",authority:"superAdmin"},{prop:"contactName",label:"联系人",authority:["superAdmin","docAdmin"]}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=y;return e(),d(k,{data:p.value,fields:a},null,8,["data"])}}}),M=F({__name:"data-descriptions.md.demo.2d2bcef8",setup(g){const p=r(),a=[{prop:"no",label:"事件编号"},{prop:"statusStr",label:"事件状态",fieldType:"tag",formatter:l=>`${l}状态`},{prop:"typeStr",label:"事件类型",formatter:l=>`${l}事件`},{prop:"contactName",label:"联系人",formatter:(l,n)=>`${l}（${n.contactTelephone}）`}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=y;return e(),d(k,{data:p.value,fields:a},null,8,["data"])}}}),V=F({__name:"data-descriptions.md.demo.2d2bcef6",setup(g){const p=r(),a=[{prop:"no",label:"事件编号"},{prop:"statusStr",label:"事件状态"},{prop:"contactName",label:"联系人",fieldType:"ciphertext",type:"blockPuzzle",formatter:l=>l==null?void 0:l.replace(/^(\S).*/,"$1**"),decrypt:(l,n)=>n.contactName},{prop:"contactTelephone",label:"联系电话",fieldType:"ciphertext",type:"clickWord",decrypt:(l,n)=>E.post("/api/decrypt/phone",{id:n.id,...l}).then(k=>k.data)}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=y;return e(),d(k,{data:p.value,fields:a},null,8,["data"])}}}),L=F({__name:"data-descriptions.md.demo.2d2bcef4",setup(g){const p=r(),a=[{prop:"no",label:"事件编号"},{prop:"statusStr",label:"事件状态",fieldType:"tag",type:(l,n)=>{switch(n.status){case"1":return"warning";case"2":return"success";default:return"primary"}}},{prop:"typeStr",label:"事件类型"},{prop:"contactName",label:"联系人"}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=y;return e(),d(k,{data:p.value,fields:a},null,8,["data"])}}}),$=F({__name:"data-descriptions.md.demo.2d2bcef2",setup(g){const p=r(),a=[{prop:"no",label:"事件编号"},{prop:"statusStr",label:"事件类型",fieldType:"tag"},{prop:"tags",label:"事件标签",fieldType:"slot"},{prop:"evaluateCount",label:"评论数",fieldType:"slot"}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=x,o=u,D=T,C=y;return e(),d(C,{data:p.value,fields:a},{tags:h(({data:B})=>[(e(!0),f(S,null,w(B.tags,b=>(e(),d(k,{type:"primary"},{default:h(()=>[i(P(b),1)]),_:2},1024))),256))]),evaluateCount:h(({data:B})=>[t(D,{value:B.evaluateCount},{default:h(()=>[t(o,null,{default:h(()=>n[0]||(n[0]=[i("查看评论")])),_:1})]),_:2},1032,["value"])]),_:1},8,["data"])}}}),q=v($,[["__scopeId","data-v-e0c22976"]]),z=F({__name:"data-descriptions.md.demo.2d2bcef0",setup(g){const p=r(),a=r([{prop:"no",label:"事件编号"},{prop:"switch",label:"是否显示手机号",fieldType:"slot"},{prop:"contactTelephone",label:"联系电话",fieldType:"ciphertext",decrypt:(l,n)=>E.post("/api/decrypt/phone",{id:n.id,...l}).then(k=>k.data),watchEffect(l){l.showPhone?this.show=!0:this.show=!1}}]);return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=_,o=y;return e(),d(o,{data:p.value,fields:a.value},{switch:h(({data:D})=>[t(k,{modelValue:D.showPhone,"onUpdate:modelValue":C=>D.showPhone=C},null,8,["modelValue","onUpdate:modelValue"])]),_:1},8,["data","fields"])}}}),R=F({__name:"data-descriptions.md.demo.2d2bceee",setup(g){const p=r(),a=[{prop:"no",label:"事件编号",labelClassName:"my-label",className:"my-content"},{prop:"statusStr",label:"事件状态"},{prop:"typeStr",label:"事件类型"},{prop:"contactName",label:"联系人",align:"right"}];return c(()=>{E.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(l=>{p.value=l.data})}),(l,n)=>{const k=u,o=y;return e(),d(o,{data:p.value,fields:a,direction:"vertical",size:"large"},{title:h(()=>n[0]||(n[0]=[i(" 自定义标题 ")])),extra:h(()=>[t(k,{type:"primary"},{default:h(()=>n[1]||(n[1]=[i("操作按钮")])),_:1})]),_:1},8,["data"])}}}),U=v(R,[["__scopeId","data-v-e549257f"]]),O={tabindex:"0"},H={tabindex:"0"},ns=JSON.parse('{"title":"Data Descriptions 数据描述列表","description":"","frontmatter":{},"headers":[],"relativePath":"component/data-descriptions.md","filePath":"component/data-descriptions.md","lastUpdated":1750662623000}'),W={name:"component/data-descriptions.md"},ts=Object.assign(W,{setup(g){return(p,a)=>{const l=m("demo"),n=m("el-button"),k=m("el-popover");return e(),f("div",null,[a[38]||(a[38]=A("",11)),t(l,{customClass:"",sourceCode:`<template>

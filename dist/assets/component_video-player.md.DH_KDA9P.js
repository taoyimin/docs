import{q as c,T as y}from"./chunks/theme.CkjlJKU3.js";import"./chunks/base.DP2rzg_V.js";/* empty css                       *//* empty css                      *//* empty css                       *//* empty css                               *//* empty css                      *//* empty css                         *//* empty css                     *//* empty css                              *//* empty css                   *//* empty css                        *//* empty css                     *//* empty css                         *//* empty css                      *//* empty css                            *//* empty css                            *//* empty css                      */import"./chunks/select.DP2rzg_V.js";/* empty css                     *//* empty css                        *//* empty css                           */import"./chunks/grid-cascader.l0sNRNKZ.js";/* empty css                         *//* empty css                     *//* empty css                      *//* empty css                         */import{d as A,p as D,o as r,c as g,G as n,F as m,_ as F,b as u,B as e,b2 as E,w as l,j as s,a as i}from"./chunks/framework.D9WNFBf3.js";const C=A({__name:"video-player.md.demo.a8234296",setup(d){const h=D({url:"https://sf1-cdn-tos.huoshanstatic.com/obj/media-fe/xgplayer_doc_video/hls/xgplayer-demo.m3u8",core:"xgplayer-hls"}),a=[[{prop:"url",label:"视频流地址",fieldType:"input",span:15},{prop:"core",label:"播放器内核",fieldType:"select",data:[{label:"xgplayer-hls",value:"xgplayer-hls"},{label:"xgplayer-flv",value:"xgplayer-flv"},{label:"xgplayer-hls.js",value:"xgplayer-hls.js"},{label:"xgplayer-flv.js",value:"xgplayer-flv.js"},{label:"metaplayer-hls-soft",value:"metaplayer-hls-soft"},{label:"metaplayer-plugin-float",value:"metaplayer-plugin-float"},{label:"metaplayer-hls-hard",value:"metaplayer-hls-hard"},{label:"metaplayer-plugin-peer",value:"metaplayer-plugin-peer"},{label:"metaplayer-webRTC",value:"metaplayer-webRTC"},{label:"metaplayer-websocket",value:"metaplayer-websocket"}],span:9}]];return(k,p)=>{const t=c,o=y;return r(),g(m,null,[n(t,{model:h.value,fields:a},null,8,["model"]),n(o,{url:h.value.url,core:h.value.core},null,8,["url","core"])],64)}}}),v=F(C,[["__scopeId","data-v-c52a0072"]]),f={};function B(d,h){const a=y;return r(),u(a,{id:"abc123456"})}const b=F(f,[["render",B],["__scopeId","data-v-66801640"]]),x={tabindex:"0"},P={tabindex:"0"},ns=JSON.parse('{"title":"Video Player 视频播放器","description":"","frontmatter":{},"headers":[],"relativePath":"component/video-player.md","filePath":"component/video-player.md","lastUpdated":1750727325000}'),w={name:"component/video-player.md"},hs=Object.assign(w,{setup(d){return(h,a)=>{const k=e("demo"),p=e("el-button"),t=e("el-popover");return r(),g("div",null,[a[26]||(a[26]=E(`<h1 id="Video Player 视频播放器" tabindex="-1">Video Player 视频播放器 <a class="header-anchor" href="#Video Player 视频播放器" aria-label="Permalink to &quot;Video Player 视频播放器&quot;">​</a></h1><p>用于播放视频流。</p><h2 id="全局配置" tabindex="-1">全局配置 <a class="header-anchor" href="#全局配置" aria-label="Permalink to &quot;全局配置&quot;">​</a></h2><p>在全局配置组件属性。</p><details class="details custom-block"><summary>VideoPlayer组件属性配置</summary><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">app.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provide</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">VIDEO_PLAYER_KEY</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, {</span></span>
...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"}")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"style"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:l(()=>[n(v)]),_:1}),a[27]||(a[27]=s("h2",{id:"动态加载",tabindex:"-1"},[i("动态加载 "),s("a",{class:"header-anchor",href:"#动态加载","aria-label":'Permalink to "动态加载"'},"​")],-1)),a[28]||(a[28]=s("p",null,[i("大部分情况下视频地址需要动态加载，只需在全局注入"),s("a",{href:"#业务注入"},"加载视频播放配置"),i("业务，后续使用组件直接设置"),s("code",null,"id"),i("属性即可自动加载视频地址及播放配置。")],-1)),n(k,{customClass:"",sourceCode:`<template>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> */</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> type</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> MetaPlayerInstance</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> InstanceType</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">typeof</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> MetaPlayer&gt;;</span></span></code></pre></div></details>`,11))])}}});export{ns as __pageData,hs as default};

...
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  });")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"});")]),i(`
`),s("span",{class:"line"},[s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),s("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),s("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:e(()=>[p(S)]),_:1}),a[29]||(a[29]=B('<h2 id="属性-事件-插槽透传" tabindex="-1">属性&amp;事件&amp;插槽透传 <a class="header-anchor" href="#属性-事件-插槽透传" aria-label="Permalink to &quot;属性&amp;事件&amp;插槽透传&quot;">​</a></h2><p>Data Table基于<a href="https://element-plus.org/zh-CN/component/table.html#table-%E5%B1%9E%E6%80%A7" target="_blank" rel="noreferrer">ElTable</a>封装，所以你可以传入<a href="https://element-plus.org/zh-CN/component/table.html#table-%E5%B1%9E%E6%80%A7" target="_blank" rel="noreferrer">ElTable</a>的所有属性和事件，并且在字段配置属性<code>fields</code>中，根据<code>fieldType</code>的不同，你可以透传属性和事件给对应的渲染组件，具体<code>fieldType</code>对应的渲染组件请查看<a href="#fieldtype可选值">fieldType可选值</a>。</p>',2)),p(l,{customClass:"",sourceCode:`<template>

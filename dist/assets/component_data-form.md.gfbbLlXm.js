import{b as D,d as E,p as F,q as T,v,r as _,s as x,t as w,f as S,h as I,u as R}from"./chunks/theme.CfErJ9sb.js";import"./chunks/base.DP2rzg_V.js";/* empty css                               *//* empty css                      *//* empty css                         *//* empty css                     *//* empty css                              *//* empty css                      *//* empty css                   *//* empty css                        *//* empty css                     *//* empty css                         *//* empty css                      *//* empty css                            *//* empty css                            *//* empty css                      */import"./chunks/select.l0sNRNKZ.js";/* empty css                     *//* empty css                        */import"./chunks/dict-select.l0sNRNKZ.js";import"./chunks/grid-cascader.l0sNRNKZ.js";/* empty css                         *//* empty css                       *//* empty css                     *//* empty css                      *//* empty css                         *//* empty css                    *//* empty css                     *//* empty css                       */import{q as c,r as d,t as g,H as o,v as f,K as e,ay as b,f as M,I as p,z as i,a1 as s,a8 as N,aR as u}from"./chunks/framework.B4KT4vS5.js";/* empty css                      *//* empty css                     *//* empty css                         *//* empty css                         */const P=c({__name:"data-form.md.demo.fb21047a",setup(y){const t=d({input:"",ciphertext:"173****8888",textarea:"",select:"",cascader:"",radio:"",checkbox:"",date:"",time:"",switch:!0,number:0,min:0,max:0,rate:0,color:"",image:"",audio:"",video:"",file:"",dict:"",grid:"",longitude:null,latitude:null,richText:""}),a=[{prop:"input",label:"输入框",fieldType:"input"},{prop:"ciphertext",label:"手机号",fieldType:"ciphertext",decrypt:(n,l)=>D.post("/api/decrypt/phone",{...n,...l}).then(h=>h.data)},{prop:"textarea",label:"文本域",fieldType:"textarea"},{prop:"select",label:"选择器",fieldType:"select",data:[{label:"选项1",value:"1"},{label:"选项2",value:"2"},{label:"选项3",value:"3"}]},{prop:"cascader",label:"级联选择器",fieldType:"cascader",data:[{label:"选项1",value:"1",children:[{label:"子选项1-1",value:"1-1"},{label:"子选项1-2",value:"1-2"}]},{label:"选项2",value:"2",children:[{label:"子选项2-1",value:"2-1"},{label:"子选项2-2",value:"2-2"},{label:"子选项2-3",value:"2-3"}]},{label:"选项3",value:"3",children:[{label:"子选项3-1",value:"3-1"},{label:"子选项3-2",value:"3-2"}]}]},{prop:"radio",label:"单选框",fieldType:"radio",data:[{label:"选项1",value:"1"},{label:"选项2",value:"2"},{label:"选项3",value:"3"}]},{prop:"checkbox",label:"多选框",fieldType:"checkbox",data:[{label:"选项1",value:"1"},{label:"选项2",value:"2"},{label:"选项3",value:"3"}]},{prop:"date",label:"日期选择器",fieldType:"date"},{prop:"time",label:"时间选择器",fieldType:"time"},{prop:"switch",label:"开关",fieldType:"switch"},{prop:"number",label:"数字输入框",fieldType:"number"},{prop:["min","max"],label:"数字范围",fieldType:"numberRange"},{prop:"rate",label:"评分",fieldType:"rate"},{prop:"color",label:"颜色",fieldType:"color"},{prop:"image",label:"图片上传",fieldType:"image",limit:1,maxSize:1024*2,extensions:["jpg","png"]},{prop:"audio",label:"音频上传",fieldType:"audio"},{prop:"video",label:"视频上传",fieldType:"video"},{prop:"file",label:"文件上传",fieldType:"file"},{prop:"dict",label:"字典选择器",fieldType:"dict",dictType:"status"},{prop:"grid",label:"网格选择器",fieldType:"grid"},{prop:["longitude","latitude"],label:"地图选点",fieldType:"location"},{prop:"richText",label:"富文本",fieldType:"richText"}];function k(n){E.success(`提交的表单内容：${JSON.stringify(n)}`)}return(n,l)=>{const h=F;return g(),o(h,{model:t.value,fields:a,onSubmit:k},null,8,["model"])}}}),q=c({__name:"data-form.md.demo.fb210478",setup(y){const t=d({no:"",status:""}),a=[{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]}];function k(m){E.success("点击了提交按钮")}function n(m){E.success("点击了查询按钮")}function l(m,B){E.success("点击了重置按钮"),B==null||B.resetFields()}function h(m){E.success("点击了新增按钮")}function r(m){E.success("点击了批量删除按钮")}function C(m){E.success("点击了返回按钮")}return(m,B)=>{const A=F;return g(),f("div",null,[e(A,{model:t.value,fields:a,onSubmit:k,onSearch:n,onReset:l,onBack:C,onAdd:h,onBatchDelete:r},null,8,["model"])])}}}),$=b(q,[["__scopeId","data-v-6295d409"]]),U=c({__name:"data-form.md.demo.fb210476",setup(y){const t=d({no:"",status:""}),a=[{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]}],k=[{name:"暂存",type:"warning",onClick:l=>{E.warning("点击了暂存按钮")}},{name:"清空",type:"danger",onClick:l=>{E.error("点击了清空按钮")}}];function n(l){E.success("点击了提交按钮")}return(l,h)=>{const r=F;return g(),o(r,{model:t.value,fields:a,buttons:k,onSubmit:n},null,8,["model"])}}}),O=c({__name:"data-form.md.demo.fb210474",setup(y){const t=d({no:"",status:""}),a=[{prop:"no",label:"事件编号",fieldType:"input",authority:"superAdmin"},{prop:"status",label:"事件状态",fieldType:"select",authority:["superAdmin","docAdmin"],data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]}],k=[{name:"暂存",type:"warning",authority:"superAdmin",onClick:h=>{E.warning("点击了带superAdmin权限的暂存按钮")}},{name:"清空",type:"danger",authority:["superAdmin","docAdmin"],onClick:h=>{E.error("点击了带superAdmin或docAdmin权限的清空按钮")}}];function n(h){E.success("点击了带superAdmin权限的提交按钮")}function l(h){E.success("点击了带superAdmin或docAdmin权限的返回按钮")}return(h,r)=>{const C=F;return g(),o(C,{model:t.value,fields:a,buttons:k,"onSubmit(superAdmin)":n,"onBack(superAdmin|docAdmin)":l},null,8,["model"])}}}),L=c({__name:"data-form.md.demo.fb210472",setup(y){const t=d({id:"123",name:"张*",phone:"173****8888"}),a=[{prop:"id"},{prop:"name",label:"姓名",fieldType:"ciphertext",type:"blockPuzzle",decrypt:(l,h)=>D.post("/api/decrypt/name",{id:h.id,...l}).then(r=>r.data)},{prop:"phone",label:"手机号",fieldType:"ciphertext",type:"clickWord",decrypt:(l,h)=>D.post("/api/decrypt/phone",{id:h.id,...l}).then(r=>r.data)}];function k(l){E.success(`提交的表单内容：${JSON.stringify(l)}`)}function n(l,h){E.success("点击了重置按钮"),h==null||h.resetFields()}return(l,h)=>{const r=F;return g(),o(r,{model:t.value,fields:a,onSubmit:k,onReset:n},null,8,["model"])}}}),V=c({__name:"data-form.md.demo.fb210470",setup(y){const t=d({no:""}),a=[{prop:"no",label:"事件编号",fieldType:"input"}];function k(h){E.success(`搜索的表单内容：${JSON.stringify(h)}`)}function n(h){E.success("点击了新增按钮")}function l(h){E.success("点击了批量删除按钮")}return(h,r)=>{const C=F;return g(),o(C,{model:t.value,fields:a,inline:"",onSearch:k,onAdd:n,onBatchDelete:l},null,8,["model"])}}}),z=c({__name:"data-form.md.demo.fb21046e",setup(y){const t=d({name:"",age:"",gender:"",address:"",phone:"",remark:""}),a=[[{prop:"name",label:"姓名",fieldType:"input"},{prop:"age",label:"年龄",fieldType:"input"},{prop:"gender",label:"性别",fieldType:"input"}],[{prop:"address",label:"家庭地址",fieldType:"input",span:16},{prop:"phone",label:"电话",fieldType:"input",span:8}],{prop:"remark",label:"详细描述",fieldType:"textarea"}];return(k,n)=>{const l=F;return g(),o(l,{model:t.value,fields:a},null,8,["model"])}}}),J=c({__name:"data-form.md.demo.fb21046c",setup(y){const t=d({id:"",no:"",status:"",addTime:"",imageUrl:""}),a=[{prop:"id",label:"事件ID"},{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]},{prop:"addTime",label:"上报时间",fieldType:"date"},{prop:"imageUrl",label:"事件图片",fieldType:"image"}];M(()=>{D.get("/api/event/detail?id=257eec9e-b752-4960-a019-945d6897d905").then(n=>{t.value=T(n.data,Object.keys(t.value))})});function k(n){E.success(`提交的表单内容：${JSON.stringify(n)}`)}return(n,l)=>{const h=F;return g(),o(h,{model:t.value,fields:a,onSubmit:k},null,8,["model"])}}}),K=c({__name:"data-form.md.demo.fb21046a",setup(y){const t=d({no:"",formType:"status",status:"",type:""}),a=d([{prop:"no",label:"编号",fieldType:"input",placeholder:"试试输入disabled"},{prop:"formType",label:"表单类型",fieldType:"radio",data:[{label:"事件状态",value:"status"},{label:"事件类型",value:"type"}],watchEffect(l){this.disabled=l.no==="disabled"}},{prop:"status",label:"事件状态",fieldType:"radio",labelKey:"dictName",valueKey:"dictCode",data:D.get("/api/dict/list?dictType=status").then(l=>l.data),watchEffect(l){this.show=l.formType==="status",this.disabled=l.no==="disabled"}},{prop:"type",label:"事件类型",fieldType:"checkbox",labelKey:"dictName",valueKey:"dictCode",data:D.get("/api/dict/list?dictType=type").then(l=>l.data),watchEffect(l){this.show=l.formType==="type",this.disabled=l.no==="disabled"}}]),k=d([{name:"重置",type:"warning",onClick:l=>{E.success("点击了重置按钮")},watchEffect(l){this.show=l.formType==="type",this.disabled=l.no==="disabled"}},{name:"返回",onClick:l=>{E.success("点击了返回按钮")},watchEffect(l){this.show=l.formType==="status",this.disabled=l.no==="disabled"}}]);function n(l){E.success(`提交的表单内容：${JSON.stringify(l)}`)}return(l,h)=>{const r=F;return g(),o(r,{model:t.value,fields:a.value,buttons:k.value,onSubmit:n},null,8,["model","fields","buttons"])}}}),Y=c({__name:"data-form.md.demo.68ff8a66",setup(y){const t=d({no:"",status:"",time:""}),a=[{prop:"no",label:"事件编号",required:!0,fieldType:"input"},{prop:"status",label:"事件状态",required:!0,fieldType:"select",data:[{label:"待处理",value:"0"},{label:"待评价",value:"1"},{label:"已办结",value:"2"}]},{prop:"time",label:"上报时间",required:!0,fieldType:"date"}],k=[{name:"自定义校验按钮",type:"success",validate:!0,onClick:l=>{E.success("校验通过！")}},{name:"只校验事件状态",type:"success",onClick:(l,h)=>{h==null||h.validateField("status",r=>{r&&E.success("校验通过！")})}},{name:"清空校验结果",type:"warning",onClick:(l,h)=>{h==null||h.clearValidate()}}];function n(l){E.success("校验通过！")}return(l,h)=>{const r=F;return g(),f("div",null,[e(r,{model:t.value,fields:a,buttons:k,onSubmit:n},null,8,["model"])])}}}),H=b(Y,[["__scopeId","data-v-73d8a1da"]]),j=c({__name:"data-form.md.demo.68ff8a64",setup(y){const t=d({name:"",age:"",phone:"",idcard:""}),a=[{prop:"name",label:"姓名",required:!0,fieldType:"input",rules:{validator:(n,l,h)=>{l?l.length<2?h(new Error("姓名必须大于等于2个字符")):l.length>4?h(new Error("姓名必须小于等于4个字符")):h():h(new Error("请输入姓名"))},trigger:["blur","change"]}},{prop:"age",label:"年龄",required:!0,fieldType:"input",rules:{validator:v,trigger:"change"}},{prop:"idcard",label:"身份证",fieldType:"input",rules:{validator:_,trigger:"blur"}},{prop:"phone",label:"手机号",fieldType:"input",required:!0,rules:[{validator:v,trigger:"change"},{validator:x,trigger:"blur"}]}];function k(n){E.success("校验通过！")}return(n,l)=>{const h=F;return g(),o(h,{model:t.value,fields:a,onSubmit:k},null,8,["model"])}}}),W={class:"mention-container"},G=c({__name:"data-form.md.demo.68ff8a62",setup(y){const t=d({no:"",status:"",person:"@"}),a=[{prop:"no",label:"事件编号",fieldType:"input"},{prop:"status",label:"事件状态",fieldType:"dict",dictType:"status"},{prop:"person",label:"处理人",fieldType:"slot"}],k=d([{label:"张三",value:"张三"},{label:"李四",value:"李四"},{label:"王五",value:"王五"},{label:"赵六",value:"赵六"}]);function n(h){E.success(`提交的表单内容：${JSON.stringify(h)}`)}function l(h){E.success("点击了指派按钮")}return(h,r)=>{const C=w,m=S,B=F;return g(),o(B,{model:t.value,fields:a,onSubmit:n},{person:p(()=>[i("div",W,[e(C,{modelValue:t.value.person,"onUpdate:modelValue":r[0]||(r[0]=A=>t.value.person=A),options:k.value,style:{width:"320px"},placeholder:"请输入"},null,8,["modelValue","options"]),e(m,{type:"success",onClick:l},{default:p(()=>r[1]||(r[1]=[s("指派")])),_:1})])]),_:1},8,["model"])}}}),Z=b(G,[["__scopeId","data-v-aaaa0e0b"]]),Q=c({__name:"data-form.md.demo.68ff8a60",setup(y){const t=d({no:"",status:[],date:"",min:10,max:30,location:"",imageUrl:"",article:"",input:""}),a=[{prop:"no",label:"事件编号",fieldType:"input",placeholder:"自定义提示",maxlength:5},{prop:"status",label:"事件状态",fieldType:"select",multiple:!0,data:[{label:"待处理",value:"0"},{label:"待评价",value:"1",disabled:!0},{label:"已办结",value:"2"}]},{prop:"date",label:"日期选择器",fieldType:"date",type:"datetime"},{prop:["min","max"],label:"数字范围",fieldType:"numberRange",min:10,max:30},{prop:"location",label:"开启定位",fieldType:"switch",inlinePrompt:!0,activeText:"完整展示多个内容",inactiveText:"多个内容"},{prop:"imageUrl",label:"事件图片",fieldType:"image",listType:"picture",limit:1,tip:"最多上传一张图片"},{prop:"article",label:"文章内容",fieldType:"richText",editor:{defaultConfig:{placeholder:"自定义提示语",MENU_CONF:{uploadImage:{maxFileSize:1*1024*1024,onError(n,l,h){E.error(`${n.name} 上传出错：${l.message}`)}}}}}}];function k(n){E.success(`提交的表单内容：${JSON.stringify(n)}`)}return(n,l)=>{const h=I,r=R,C=F;return g(),o(C,{model:t.value,fields:a,onSubmit:k},{default:p(()=>[e(r,{prop:"input",label:"插槽输入框"},{default:p(()=>[e(h,{modelValue:t.value.input,"onUpdate:modelValue":l[0]||(l[0]=m=>t.value.input=m),placeholder:"请输入"},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])}}}),Mi=JSON.parse('{"title":"Data Form 数据表单","description":"","frontmatter":{},"headers":[],"relativePath":"component/data-form.md","filePath":"component/data-form.md","lastUpdated":1740561433000}'),X={name:"component/data-form.md"},Ni=Object.assign(X,{setup(y){return(t,a)=>{const k=N("demo");return g(),f("div",null,[a[13]||(a[13]=u(`<h1 id="data-form-数据表单" tabindex="-1">Data Form 数据表单 <a class="header-anchor" href="#data-form-数据表单" aria-label="Permalink to &quot;Data Form 数据表单&quot;">​</a></h1><p>该组件用于快速生成数据表单，内部封装了表单渲染、表单验证、文件处理等逻辑，只需传入<a href="#属性">fields</a>和<a href="#属性">model</a>属性即可。</p><h2 id="全局配置" tabindex="-1">全局配置 <a class="header-anchor" href="#全局配置" aria-label="Permalink to &quot;全局配置&quot;">​</a></h2><p>在全局配置组件属性。</p><details class="details custom-block"><summary>DataForm组件属性配置</summary><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">app.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provide</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">DATA_FORM_KEY</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, {</span></span>

import{b as m,g as F,d as v}from"./chunks/theme.CBHJX1Ld.js";import"./chunks/base.l0sNRNKZ.js";/* empty css                    *//* empty css                        *//* empty css                        */import{d as o,r as u,e as g,f as C,I as k,u as b,J as A,az as B,M as D,a8 as x,aS as c,L as d,h as s,Q as i}from"./chunks/framework.DZUnRBGi.js";/* empty css                    *//* empty css                     *//* empty css                       */const f=o({__name:"checkbox.md.demo.5155e785",setup(y){const l=u([]),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}],t=m.get("/api/dict/list?dictType=status").then(n=>n.data);function e(n){setTimeout(()=>{n(a)},1500)}function E(){return a}return(n,h)=>{const r=F;return g(),C(A,null,[k(r,{modelValue:l.value,"onUpdate:modelValue":h[0]||(h[0]=p=>l.value=p),data:a},null,8,["modelValue"]),k(r,{modelValue:l.value,"onUpdate:modelValue":h[1]||(h[1]=p=>l.value=p),data:b(t),"label-key":"dictName","value-key":"dictCode"},null,8,["modelValue","data"]),k(r,{modelValue:l.value,"onUpdate:modelValue":h[2]||(h[2]=p=>l.value=p),data:e},null,8,["modelValue"]),k(r,{modelValue:l.value,"onUpdate:modelValue":h[3]||(h[3]=p=>l.value=p),data:E},null,8,["modelValue"])],64)}}}),_=B(f,[["__scopeId","data-v-ff47de84"]]),V=o({__name:"checkbox.md.demo.5155e786",setup(y){const l=u([]),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}];return(t,e)=>{const E=F;return g(),D(E,{modelValue:l.value,"onUpdate:modelValue":e[0]||(e[0]=n=>l.value=n),data:a,type:"button"},null,8,["modelValue"])}}}),T=o({__name:"checkbox.md.demo.5155e787",setup(y){const l=u([]),a=[{label:"待处理",value:"1",border:!0},{label:"处理中",value:"2",disabled:!0},{label:"待评论",value:"3",checked:!0},{label:"已办结",value:"4",size:"small"}],t=e=>{v.success(`选中的值改变了:${e}`)};return(e,E)=>{const n=F;return g(),D(n,{modelValue:l.value,"onUpdate:modelValue":E[0]||(E[0]=h=>l.value=h),data:a,max:2,onChange:t},null,8,["modelValue"])}}}),I=JSON.parse('{"title":"Checkbox 多选框","description":"","frontmatter":{},"headers":[],"relativePath":"component/checkbox.md","filePath":"component/checkbox.md","lastUpdated":1730196590000}'),P={name:"component/checkbox.md"},O=Object.assign(P,{setup(y){return(l,a)=>{const t=x("demo");return g(),C("div",null,[a[3]||(a[3]=c(`<h1 id="checkbox-多选框" tabindex="-1">Checkbox 多选框 <a class="header-anchor" href="#checkbox-多选框" aria-label="Permalink to &quot;Checkbox 多选框&quot;">​</a></h1><p>用于表单多选数据。</p><h2 id="全局配置" tabindex="-1">全局配置 <a class="header-anchor" href="#全局配置" aria-label="Permalink to &quot;全局配置&quot;">​</a></h2><p>在全局配置组件属性。</p><details class="details custom-block"><summary>Checkbox组件属性配置</summary><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">app.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provide</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">CHECKBOX_KEY</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, {</span></span>

import{b as B,Q as o,d as v,e as b,f}from"./chunks/theme.C9jPID2_.js";import"./chunks/base.l0sNRNKZ.js";/* empty css                   *//* empty css                      *//* empty css                         *//* empty css                      */import"./chunks/select.DP2rzg_V.js";import{d as c,p as u,o as g,c as D,G as l,k as x,F as A,_ as m,b as T,w as t,a as i,B as F,b2 as C,j as s}from"./chunks/framework.Cv9N_OZb.js";/* empty css                    *//* empty css                      *//* empty css                        *//* empty css                     *//* empty css                       */const V=c({__name:"select.md.demo.71e21672",setup(y){const k=u(""),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}],E=B.get("/api/dict/list?dictType=status").then(e=>e.data);function r(e){setTimeout(()=>{e(a)},1500)}function h(){return a}return(e,n)=>{const p=o;return g(),D(A,null,[l(p,{modelValue:k.value,"onUpdate:modelValue":n[0]||(n[0]=d=>k.value=d),data:a},null,8,["modelValue"]),l(p,{modelValue:k.value,"onUpdate:modelValue":n[1]||(n[1]=d=>k.value=d),data:x(E),"label-key":"dictName","value-key":"dictCode"},null,8,["modelValue","data"]),l(p,{modelValue:k.value,"onUpdate:modelValue":n[2]||(n[2]=d=>k.value=d),data:r},null,8,["modelValue"]),l(p,{modelValue:k.value,"onUpdate:modelValue":n[3]||(n[3]=d=>k.value=d),data:h},null,8,["modelValue"])],64)}}}),S=m(V,[["__scopeId","data-v-6eca7119"]]),P=c({__name:"select.md.demo.71e21673",setup(y){const k=u(""),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}];function E(h){setTimeout(()=>{h(a)},1500)}function r(){return new Promise(h=>{setTimeout(()=>{h(a)},1500)})}return(h,e)=>{const n=o;return g(),D(A,null,[l(n,{modelValue:k.value,"onUpdate:modelValue":e[0]||(e[0]=p=>k.value=p),data:E,lazy:""},null,8,["modelValue"]),l(n,{modelValue:k.value,"onUpdate:modelValue":e[1]||(e[1]=p=>k.value=p),data:r,lazy:""},null,8,["modelValue"])],64)}}}),_=m(P,[["__scopeId","data-v-36b10d8c"]]),w=c({__name:"select.md.demo.71e21674",setup(y){const k=u([]),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}],E=r=>{v.success(`选中的值改变了:${r}`)};return(r,h)=>{const e=b,n=f,p=o;return g(),T(p,{modelValue:k.value,"onUpdate:modelValue":h[0]||(h[0]=d=>k.value=d),data:a,clearable:"",multiple:"",size:"large",placeholder:"自定义提示",onChange:E},{header:t(()=>[l(e,null,{default:t(()=>h[1]||(h[1]=[i("全选")])),_:1})]),footer:t(()=>[l(n,null,{default:t(()=>h[2]||(h[2]=[i("确定")])),_:1})]),_:1},8,["modelValue"])}}}),z={tabindex:"0"},Y=JSON.parse('{"title":"Select 选择器","description":"","frontmatter":{},"headers":[],"relativePath":"component/select.md","filePath":"component/select.md","lastUpdated":1745550734000}'),N={name:"component/select.md"},H=Object.assign(N,{setup(y){return(k,a)=>{const E=F("demo"),r=F("el-button"),h=F("el-popover");return g(),D("div",null,[a[22]||(a[22]=C("",7)),l(E,{customClass:"",sourceCode:`<template>

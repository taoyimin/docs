import{b as d,d as r,j as F,x as m,y as b,o as f,z as T}from"./chunks/theme.C9jPID2_.js";import"./chunks/base.DP2rzg_V.js";/* empty css                          *//* empty css                        *//* empty css                      *//* empty css                      *//* empty css                         *//* empty css                   *//* empty css                      *//* empty css                       *//* empty css                      *//* empty css                            *//* empty css                      *//* empty css                    *//* empty css                     *//* empty css                       */import{d as c,p as A,v as D,o as g,b as o,w as k,G as t,a as i,t as v,B as u,c as x,b2 as B,j as s}from"./chunks/framework.Cv9N_OZb.js";/* empty css                        *//* empty css                   */const w=c({__name:"data-table.md.demo.3197af21",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"statusName",label:"事件状态",fieldType:"tag"},{prop:"contactTelephone",label:"联系电话",fieldType:"ciphertext",decrypt:(h,n)=>d.post("/api/decrypt/phone",{id:n.id,...h}).then(l=>l.data)},{prop:"id",label:"二维码",fieldType:"qrcode"},{prop:"id",label:"操作",fieldType:"button",formatter:()=>"下载",type:"success",onClick:(h,n,l)=>{r.success(`点击了第${n+1}行的按钮`)}},{prop:"dealFlag",label:"开关",fieldType:"switch",onChange:(h,n,l,e)=>{r.success(`点击了第${l+1}行的开关`)}},{prop:"imageUrl",label:"事件图片",fieldType:"image"}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=F;return g(),o(l,{data:p.value,fields:a},null,8,["data"])}}}),_=c({__name:"data-table.md.demo.3197af22",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型"},{prop:"statusName",label:"事件状态"}];D(()=>{d.get("/api/event/table").then(e=>{p.value=e.data.records})});function h(e,E){r.success(`点击了第${E+1}行的详情按钮`)}function n(e,E){r.warning(`点击了第${E+1}行的编辑按钮`)}function l(e,E){r.error(`点击了第${E+1}行的删除按钮`)}return(e,E)=>{const C=F;return g(),o(C,{data:p.value,fields:a,onDetail:h,onEdit:n,onDelete:l},null,8,["data"])}}}),N=c({__name:"data-table.md.demo.3197af23",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型"},{prop:"statusName",label:"事件状态"}],h=[{name:"点赞",type:"success",onClick:(l,e)=>{r.success(`点击了第${e+1}的点赞按钮`)}},{name:"收藏",type:"warning",onClick:(l,e)=>{r.warning(`点击了第${e+1}的收藏按钮`)}},{name:"取消收藏",type:"danger",onClick:(l,e)=>{r.error(`点击了第${e+1}的取消收藏按钮`)}}];D(()=>{d.get("/api/event/table").then(l=>{p.value=l.data.records})});function n(l,e){r.success(`查看编号：${l.no}的事件`)}return(l,e)=>{const E=F;return g(),o(E,{data:p.value,fields:a,buttons:h,onDetail:n},null,8,["data"])}}}),V=c({__name:"data-table.md.demo.3197af24",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型",authority:"superAdmin"},{prop:"statusName",label:"事件状态",authority:["superAdmin","docAdmin"]}],h=[{name:"点赞",type:"success",authority:"superAdmin",onClick:(e,E)=>{r.warning("点击了带superAdmin权限的点赞按钮")}},{name:"收藏",type:"warning",authority:["superAdmin","docAdmin"],onClick:(e,E)=>{r.warning("点击了带superAdmin或docAdmin权限的收藏按钮")}}];D(()=>{d.get("/api/event/table").then(e=>{p.value=e.data.records})});function n(e,E){r.success("点击了带superAdmin权限的编辑按钮")}function l(e,E){r.success("点击了带superAdmin或docAdmin权限的删除按钮")}return(e,E)=>{const C=F;return g(),o(C,{data:p.value,fields:a,buttons:h,"onEdit(superAdmin)":n,"onDelete(superAdmin|docAdmin)":l},null,8,["data"])}}}),M=c({__name:"data-table.md.demo.3197af25",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型",formatter:(h,n,l,e)=>`${l}事件`},{prop:"contactName",label:"联系人",formatter:(h,n,l,e)=>`${l}（${h.contactTelephone}）`}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=F;return g(),o(l,{data:p.value,fields:a},null,8,["data"])}}}),P=c({__name:"data-table.md.demo.3197af26",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"desc",label:"事件描述"},{prop:"statusName",label:"事件状态",fieldType:"tag"},{prop:"contactName",label:"联系人",fieldType:"ciphertext",type:"blockPuzzle",formatter:(h,n,l)=>l==null?void 0:l.replace(/^(\S).*/,"$1**"),decrypt:(h,n)=>n.contactName},{prop:"contactTelephone",label:"联系电话",fieldType:"ciphertext",type:"clickWord",decrypt:(h,n)=>d.post("/api/decrypt/phone",{id:n.id,...h}).then(l=>l.data)}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=F;return g(),o(l,{data:p.value,fields:a},null,8,["data"])}}}),$=c({__name:"data-table.md.demo.3197af27",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型"},{prop:"statusName",label:"事件状态",fieldType:"tag",type:(h,n,l)=>{switch(h.status){case"1":return"warning";case"2":return"success";default:return"primary"}}}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=F;return g(),o(l,{data:p.value,fields:a},null,8,["data"])}}}),R=c({__name:"data-table.md.demo.3197af28",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型"},{prop:"status",label:"操作",fieldType:"button",type:(h,n,l)=>{switch(h.status){case"1":return"warning";case"2":return"success";default:return"primary"}},formatter:(h,n,l,e)=>{switch(l){case"1":return"处理";case"2":return"评价";default:return"办结"}},onClick:(h,n,l)=>{switch(l){case"1":return new Promise((e,E)=>{setTimeout(()=>{r.success("处理成功"),e(!0)},3e3)});case"2":r.success("点击了评价按钮");break;case"3":r.success("点击了办结按钮");break;default:r.success(`点击了第${n+1}行的按钮`);break}}}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=F;return g(),o(l,{data:p.value,fields:a},null,8,["data"])}}}),S=c({__name:"data-table.md.demo.3197af29",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"archiveFlag",label:"归档状态(archiveFlag)",formatter:(h,n,l,e)=>l==="0"?"未归档":"已归档"},{prop:"archiveFlagName",label:"归档状态(archiveFlagName)"},{prop:"archiveFlag",label:"是否归档",fieldType:"switch",activeValue:"1",inactiveValue:"0",beforeChange:(h,n,l)=>n===0?!0:n===1?(r.error("归档失败"),!1):n===2?new Promise((e,E)=>{setTimeout(()=>{e(!0)},3e3)}):new Promise((e,E)=>{setTimeout(()=>{r.error("归档失败"),E(new Error("归档失败"))},3e3)}),onChange:(h,n,l,e)=>{e==="0"?n.archiveFlagName="未归档":n.archiveFlagName="已归档"}}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=F;return g(),o(l,{data:p.value,fields:a},null,8,["data"])}}}),q=c({__name:"data-table.md.demo.015e352f",setup(y){const p=A([]),a=[{prop:"no",label:"事件编号"},{prop:"typeName",label:"事件类型",formatter:(h,n,l,e)=>`${l}事件`},{prop:"progress",label:"自定义列",fieldType:"slot",width:300}];return D(()=>{d.get("/api/event/table").then(h=>{p.value=h.data.records})}),(h,n)=>{const l=m,e=F;return g(),o(e,{data:p.value,fields:a},{progress:k(({row:E,$index:C})=>[t(l,{"text-inside":!0,"stroke-width":16,percentage:E.progress,status:C%2?"warning":"success"},null,8,["percentage","status"])]),_:1},8,["data"])}}}),I=c({__name:"data-table.md.demo.015e3530",setup(y){const p=[{dictCode:"1",dictName:"字典1",dictRemark:"字典1描述",isValid:"0"},{dictCode:"2",dictName:"字典2",dictRemark:"字典2描述",isValid:"0",children:[{dictCode:"2-1",dictName:"字典2-1",dictRemark:"字典2-1描述",isValid:"1"},{dictCode:"2-2",dictName:"字典2-2",dictRemark:"字典2-2描述",isValid:"0"}]},{dictCode:"3",dictName:"字典3",dictRemark:"字典3描述",isValid:"1"}],a=[{type:"selection"},{prop:"dictCode",label:"字典值",width:120},{prop:"dictName",label:"字典名称",width:120,sortable:!0},{prop:"isValid",label:"是否生效",fieldType:"switch",activeValue:"1",inactiveValue:"0",activeText:"生效",inactiveText:"未生效"},{prop:"id",label:"操作",fieldType:"button",name:"编辑",type:"warning",plain:!1,round:!0,icon:b,onClick:(h,n,l)=>{r.warning(`点击了第${n+1}行的编辑按钮`)}}];return(h,n)=>{const l=f,e=T,E=F;return g(),o(E,{data:p,fields:a,"row-key":"dictCode",stripe:"","default-expand-all":""},{empty:k(()=>n[0]||(n[0]=[i(" 自定义提示内容 ")])),default:k(()=>[t(e,{label:"字典描述"},{default:k(({row:C})=>[t(l,null,{default:k(()=>[i(v(C.dictRemark),1)]),_:2},1024)]),_:1})]),_:1})}}}),z={tabindex:"0"},L={tabindex:"0"},O={tabindex:"0"},j={tabindex:"0"},Es=JSON.parse('{"title":"Data Table 数据表格","description":"","frontmatter":{},"headers":[],"relativePath":"component/data-table.md","filePath":"component/data-table.md","lastUpdated":1745550734000}'),U={name:"component/data-table.md"},rs=Object.assign(U,{setup(y){return(p,a)=>{const h=u("demo"),n=u("el-button"),l=u("el-popover");return g(),x("div",null,[a[84]||(a[84]=B("",12)),t(h,{customClass:"",sourceCode:`<template>

import{b as v,g as c,d as A}from"./chunks/theme.C9jPID2_.js";import"./chunks/base.DP2rzg_V.js";/* empty css                        *//* empty css                        */import{d as u,p as C,o as g,c as m,G as h,k as b,F as B,_ as x,b as D,B as F,b2 as o,w as k,j as s,a as i}from"./chunks/framework.Cv9N_OZb.js";/* empty css                    *//* empty css                     *//* empty css                       */const f=u({__name:"checkbox.md.demo.52027a8e",setup(y){const l=C([]),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}],E=v.get("/api/dict/list?dictType=status").then(p=>p.data);function t(p){setTimeout(()=>{p(a)},1500)}function e(){return a}return(p,n)=>{const d=c;return g(),m(B,null,[h(d,{modelValue:l.value,"onUpdate:modelValue":n[0]||(n[0]=r=>l.value=r),data:a},null,8,["modelValue"]),h(d,{modelValue:l.value,"onUpdate:modelValue":n[1]||(n[1]=r=>l.value=r),data:b(E),"label-key":"dictName","value-key":"dictCode"},null,8,["modelValue","data"]),h(d,{modelValue:l.value,"onUpdate:modelValue":n[2]||(n[2]=r=>l.value=r),data:t},null,8,["modelValue"]),h(d,{modelValue:l.value,"onUpdate:modelValue":n[3]||(n[3]=r=>l.value=r),data:e},null,8,["modelValue"])],64)}}}),T=x(f,[["__scopeId","data-v-b7e73cb1"]]),_=u({__name:"checkbox.md.demo.52027a8c",setup(y){const l=C([]),a=[{label:"待处理",value:"1"},{label:"处理中",value:"2"},{label:"待评论",value:"3"},{label:"已办结",value:"4"}];return(E,t)=>{const e=c;return g(),D(e,{modelValue:l.value,"onUpdate:modelValue":t[0]||(t[0]=p=>l.value=p),data:a,type:"button"},null,8,["modelValue"])}}}),V=u({__name:"checkbox.md.demo.52027a8a",setup(y){const l=C([]),a=[{label:"待处理",value:"1",border:!0},{label:"处理中",value:"2",disabled:!0},{label:"待评论",value:"3",checked:!0},{label:"已办结",value:"4",size:"small"}],E=t=>{A.success(`选中的值改变了:${t}`)};return(t,e)=>{const p=c;return g(),D(p,{modelValue:l.value,"onUpdate:modelValue":e[0]||(e[0]=n=>l.value=n),data:a,max:2,onChange:E},null,8,["modelValue"])}}}),P={tabindex:"0"},$=JSON.parse('{"title":"Checkbox 多选框","description":"","frontmatter":{},"headers":[],"relativePath":"component/checkbox.md","filePath":"component/checkbox.md","lastUpdated":1745550734000}'),w={name:"component/checkbox.md"},M=Object.assign(w,{setup(y){return(l,a)=>{const E=F("demo"),t=F("el-button"),e=F("el-popover");return g(),m("div",null,[a[22]||(a[22]=o("",7)),h(E,{customClass:"",sourceCode:`<template>

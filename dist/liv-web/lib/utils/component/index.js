...
function getPropsPoxy(target, globalProps) {
  ...
  const propsDefaults = (
    // @ts-ignore
    (_a = vue.getCurrentInstance()) == null ? void 0 : _a.propsDefaults
  );
    ...
    get: (target2, prop, receiver) => {
      ...
      if (value !== void 0 && (propsDefaults == null ? void 0 : propsDefaults[prop]) === void 0) {
        if (typeof (globalProps == null ? void 0 : globalProps[prop]) === "object" && typeof value === "object") {
          return Object.assign(lodashEs.cloneDeep(globalProps[prop]), value);
        } else {
          return value;
        }
      } else {
...
exports.checkAuthoritys = checkAuthoritys;
exports.getPropsPoxy = getPropsPoxy;

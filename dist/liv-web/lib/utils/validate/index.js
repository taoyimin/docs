...
var index = require('../regex/index.js');
...
const validatePassword = (rule, value, callback) => {
  ...
  if (value === void 0 || value === null || value === "") {
    ...
    } else if (!index.matchPassword(value)) {
...
const validateDecimal = (rule, value, callback) => {
  ...
  if (value === void 0 || value === null || value === "") {
    ...
    if (!index.matchDecimal(value, { minDigits: 1 })) {
...
function createValidateDecimal(options) {
  return (rule, value, callback) => {
    ...
    if (value === void 0 || value === null || value === "") {
      ...
      } else if (!index.matchDecimal(value, {
...
exports.createValidateDecimal = createValidateDecimal;

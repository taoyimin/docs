...
var _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const globalProps = vue.inject(component.RADIO_KEY, {});
    const props = __props;
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElRadioGroup), vue.mergeProps({ class: "liv-radio-group" }, vue.unref(lodashEs.pick)(vue.unref(globalProps), Object.keys(vue.unref(elementPlus.radioGroupProps))), {
        ...
        default: vue.withCtx(() => [
          vue.unref(propsProxy).type === "button" ? (vue.openBlock(true), vue.createElementBlock(
            ...
            vue.renderList(options.value, (item) => {
              return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElRadioButton), vue.mergeProps({

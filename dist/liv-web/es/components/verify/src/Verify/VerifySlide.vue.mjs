...
import { toRefs, getCurrentInstance, ref, reactive, computed, nextTick, watch, onMounted, resolveComponent, openBlock, createElementBlock, normalizeStyle, createElementVNode, withDirectives, createVNode, withCtx, vShow, Transition, normalizeClass, toDisplayString, createCommentVNode } from 'vue';
import { ElIcon } from 'element-plus';
import { RefreshRight, ArrowRightBold, Select, CloseBold } from '@element-plus/icons-vue';
import _export_sfc from '../../../../_virtual/_plugin-vue_export-helper.mjs';
import { aesEncrypt } from '../../../../utils/encrypt/index.mjs';

const _sfc_main = {
  name: "VerifySlide",
  components: { ElIcon, RefreshRight, ArrowRightBold, Select, CloseBold },
  props: {
    captchaType: {
      type: String
    },
  ...
  setup(props, context) {
    ...
    let secretKey = ref(""), passFlag = ref(""), backImgBase = ref(""), blockBackImgBase = ref(""), backToken = ref(""), startMoveTime = ref(""), endMovetime = ref(""), tipsBackColor = ref(""), tipWords = ref(""), text = ref(""), finishText = ref(""), setSize = reactive({
      imgHeight: 0,
      imgWidth: 0,
      barHeight: 0,
      barWidth: 0
    }), top = ref(0), left = ref(0), moveBlockLeft = ref(void 0), leftBarWidth = ref(void 0), moveBlockBackgroundColor = ref(void 0), leftBarBorderColor = ref("var(--liv-verify-border-color)"), iconColor = ref(void 0), iconClass = ref("icon-right"), status = ref(false), isEnd = ref(false), showRefresh = ref(true), transitionLeft = ref(""), transitionWidth = ref(""), startLeft = ref(0);
    ...
    function end() {
      ...
      if (status.value && isEnd.value == false) {
        ...
        let data = {
          ...
          pointJson: secretKey.value ? aesEncrypt(JSON.stringify({ x: moveLeftDistance, y: 5 }), secretKey.value) : JSON.stringify({ x: moveLeftDistance, y: 5 }),
        ...
        if (props.reqCheck) {
          props.reqCheck(data).then((res) => {
            if (res.repCode == "0000") {
              ...
              var captchaVerification = secretKey.value ? aesEncrypt(
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    $props.type === "2" ? (openBlock(), createElementBlock(
      "div",
      {
        key: 0,
        class: "verify-img-out",
        style: normalizeStyle({ height: parseInt($setup.setSize.imgHeight) + $props.vSpace + "px" })
      },
      [
        createElementVNode(
          "div",
          {
            ...
            style: normalizeStyle({ width: $setup.setSize.imgWidth, height: $setup.setSize.imgHeight })
          },
          [
            ...
            createVNode(Transition, { name: "tips" }, {
              default: withCtx(() => [
                $setup.tipWords ? (openBlock(), createElementBlock(
                  "span",
                  {
                    key: 0,
                    class: normalizeClass(["verify-tips", $setup.passFlag ? "suc-bg" : "err-bg"])
                  },
                  toDisplayString($setup.tipWords),
                  3
                  /* TEXT, CLASS */
    ...
    createCommentVNode(" \u516C\u5171\u90E8\u5206 "),
    createElementVNode(
      "div",
      {
        class: "verify-bar-area",
        style: normalizeStyle({ width: $setup.setSize.imgWidth, height: $props.barSize.height, "line-height": $props.barSize.height })
      },
      [
        createElementVNode("span", {
          class: "verify-msg",
          textContent: toDisplayString($setup.text)
        }, null, 8, _hoisted_3),
        createElementVNode(
          "div",
          {
          ...
          [
            createElementVNode("span", {
              class: "verify-msg",
              textContent: toDisplayString($setup.finishText)
            }, null, 8, _hoisted_4),
            createElementVNode(
              "div",
              {
                ...
                createVNode(_component_el_icon, {
                  ...
                  default: withCtx(() => [
                    withDirectives(createVNode(
                      ...
                      [vShow, $setup.iconClass === "icon-right"]
                    ]),
                    withDirectives(createVNode(
                      _component_Select,
                      null,
                      ...
                      [vShow, $setup.iconClass === "icon-check"]
                    ]),
                    withDirectives(createVNode(
                      ...
                      [vShow, $setup.iconClass === "icon-close"]
                    ])
                  ]),
                  _: 1
                  /* STABLE */
...
var VerifySlide = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);

export { VerifySlide as default };
//# sourceMappingURL=VerifySlide.vue.mjs.map

import type { AMapProps, AMapLayer } from './a-map';
/**
 * 组件属性
 */
declare let __VLS_typeProps: AMapProps;
declare const __VLS_defaults: {
    layersIndex: number;
};
type __VLS_PublicProps = {
    'layersIndex'?: typeof __VLS_defaults['layersIndex'];
...
declare const _default: import("vue").DefineComponent<__VLS_PublicProps, {
    ...
    layers: AMapLayer[];
    layersButtons: import("./a-map").AMapLayerButton[];

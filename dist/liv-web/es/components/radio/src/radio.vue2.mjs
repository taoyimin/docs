...
import { ElRadioGroup, radioGroupProps, ElRadioButton, ElRadio } from 'element-plus';
import { pick, omit } from 'lodash-es';
import '../../../utils/index.mjs';
import '../../../constants/index.mjs';
import { RADIO_KEY } from '../../../constants/inject/component.mjs';
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const globalProps = inject(RADIO_KEY, {});
    const props = __props;
    ...
    function initData(data) {
      if (!data) {
        ...
        throw new Error("[liv-web/radio]data\u5C5E\u6027\u53EA\u80FD\u662F\u6570\u7EC4\u3001Promise\u3001Callback\u51FD\u6570\u3001Getter\u51FD\u6570\u3002");
      }
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElRadioGroup), mergeProps({ class: "liv-radio-group" }, unref(pick)(unref(globalProps), Object.keys(unref(radioGroupProps))), {
        ...
        default: withCtx(() => [
          unref(propsProxy).type === "button" ? (openBlock(true), createElementBlock(
            ...
            renderList(options.value, (item) => {
              return openBlock(), createBlock(unref(ElRadioButton), mergeProps({
                class: "liv-radio-button",
